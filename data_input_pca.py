...
def input_data_pca(data_path,data,train_rate1):
    ...
    transform_data={'min_max_scaler_X':standard_scaler_X,'min_max_scaler_DIA':standard_scaler_DIA,'min_max_scaler_SYS':standard_scaler_SYS}

    dia = standard_scaler_DIA.inverse_transform(DIA_test_minmax)
    #plt.plot(dia, 'k-*')
    #plt.show()
